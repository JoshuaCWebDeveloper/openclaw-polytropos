...
type SlackChatStreamer = Pick<ChatStreamer, "append" | "stop">;

type SlackStreamingClient = SlackApiClient & {
  chatStream: (params: Parameters<WebClient["chatStream"]>[0]) => SlackChatStreamer;
};

...
const OPENAI_CODEX_GPT_56_SOL_NATIVE_CONTEXT_TOKENS = 1_050_000;
...
const OPENAI_CODEX_GPT_56_SOL_TEMPLATE_MODEL_IDS = [
...
function resolveCodexForwardCompatModel(ctx: ProviderResolveDynamicModelContext) {
  ...
  if (lower === OPENAI_CODEX_GPT_56_SOL_MODEL_ID) {
    templateIds = OPENAI_CODEX_GPT_56_SOL_TEMPLATE_MODEL_IDS;
    patch = {
      contextWindow: OPENAI_CODEX_GPT_56_SOL_NATIVE_CONTEXT_TOKENS,
      contextTokens: OPENAI_CODEX_GPT_55_DEFAULT_RUNTIME_CONTEXT_TOKENS,
      maxTokens: OPENAI_CODEX_GPT_54_MAX_TOKENS,
